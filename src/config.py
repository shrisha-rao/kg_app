...
#     # Graph DB
#     arangodb_host: str = Field(..., env="ARANGODB_HOST")
#     arangodb_username: str = Field(..., env="ARANGODB_USERNAME")
#     arangodb_password: str = Field(..., env="ARANGODB_PASSWORD")
#     arangodb_database: str = Field(..., env="ARANGODB_DATABASE")
#     arangodb_test_db: str = Field(..., env="ARANGODB_TEST_DB")
...
#     vector_db_type: str = Field("vertex_ai_matching_engine",
#                                 env="VECTOR_DB_TYPE")
...
#     # vertex_ai_index_endpoint_id: str = Field(...,
#     #                                          env="VERTEX_AI_INDEX_ENDPOINT_ID")
#     # vertex_ai_index_region: str = Field(..., env="VERTEX_AI_INDEX_REGION")
