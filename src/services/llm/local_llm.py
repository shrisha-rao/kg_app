...
class LocalLLMService(LLMService):
    ...
    # async def _generate_ollama_structured_response(
    #         self,
    #         prompt: str,
    #         response_format: Dict[str, Any],
    #         context: Optional[str] = None,
    ...
    #     # Add format instructions to prompt for structured response
    #     structured_prompt = f"""{prompt}
    ...
    #     # Parse JSON from response (simple fallback if parsing fails)
    #     try:
    #         import json
